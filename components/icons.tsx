...
export const WrenchScrewdriverIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.423 3a2.25 2.25 0 00-2.13 1.557L8.067 8.337a2.25 2.25 0 01-1.127 1.34L3.89 11.23a2.25 2.25 0 00-1.171 2.871l.52 1.306a2.25 2.25 0 002.87 1.17l3.048-1.218a2.25 2.25 0 011.339.127l3.585 1.517a2.25 2.25 0 002.83-1.107l.52-1.306a2.25 2.25 0 00-1.17-2.871l-3.048-1.218a2.25 2.25 0 011.127-1.34l3.585-1.517A2.25 2.25 0 0011.423 3zm3.72 13.98l.582 1.46c.15.378.02.812-.313 1.054a3.75 3.75 0 01-4.831-.383l-.707-.707a3.75 3.75 0 01-.383-4.832c.242-.333.676-.463 1.054-.313l1.46.582a1.125 1.125 0 001.275-.205l3.204-3.204a1.125 1.125 0 00-1.591-1.591l-3.204 3.204a1.125 1.125 0 00-.205 1.275l.582 1.461z" />
  </svg>
);
...
export const PresentationChartLineIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0V3m8.25 2.25h-3m3 3h-3m3 3h-3m-10.5 2.25l2.25-2.25 2.25 2.25 2.25-2.25" />
  </svg>
);
